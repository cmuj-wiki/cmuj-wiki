# Biochemia z elementami chemii - Kolokwium 2
...
### Temat: **Genetyka / biologia molekularna**
...
📥 [Zobacz zalecane podręczniki](../../semestr-1/biochemia.md#literatura)

📥 [Pobierz podręczniki z MedBox](../../zasoby/medbox/semestr-1.md#biochemia)

### Pytania z poprzednich lat

📝 [Pytania z kolokwiów - MedBox](../../zasoby/medbox/semestr-1.md#biochemia)
...
!!! tip "Podziel się swoimi wskazówkami!"
    ...
    [Edytuj tę stronę](https://github.com/yourusername/cmuj-wiki/edit/main/docs/kolokwia/semestr-1/biochemia-kolokwia-2.md)
...
- 📚 [Zasoby MedBox](../../zasoby/medbox/semestr-1.md#biochemia)
